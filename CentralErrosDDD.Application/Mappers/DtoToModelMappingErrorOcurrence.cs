...
{
    public class DtoToModelMappingErrorOcurrence : Profile
    {
        public DtoToModelMappingErrorOcurrence()
        {
            ErrorOcurrenceMap();
        }

        private void ErrorOcurrenceMap()
        {
            CreateMap<ErrorOcurrenceDTO, ErrorOcurrence>()
